...
const RandomCard = (props: propsType) => {
    ...
    return (
        <>
            <div className="border-[1px] border-[#fff] w-[100%] sm:w-[75%] md:w-[75%] lg:w-[60%] h-[auto]  overflow-scroll bg-white p-[1.5rem] rounded-lg no-scrollbar mt-5 mb-5">
                ...
                {props.series && (
                    <div className='flex justify-between px-0 sm:px-0 md:px-4 lg:px-10 text-xl font-semibold mt-4'>
                        <p>{props.series}</p>
