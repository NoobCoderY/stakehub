...
const QouteCard = ({text,author,id}:propsType) => {
  return (
      <>
            <div className="  basis-[30%] rounded-md flex flex-col items-center justify-center  mx-auto mt-[2rem] px-[1rem]" key={id}>
            <div className="border-[1px] border-[#fff] w-[100%] h-[50vh] overflow-scroll bg-white p-[1.5rem] rounded-lg no-scrollbar">
